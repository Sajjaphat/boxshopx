                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="banner-img-wp">
                                    <div class="banner-img" style="background-image: url(assets/images/logo4.jpg);">
                                    </div>
                                </div>
                ...
                <div class="sec-wp">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="sec-title text-center mb-5">
                                    ...
                                    <h2 class="h2-title">เมนูอาหาร </h2>
                        ...
                        <div class="menu-list-row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 dish-box-wp breakfast" data-cat="breakfast" style="display: inline-block;">
                                ...
                                <!-- 3 -->
                                <div class="col-lg-3 col-md-4 col-sm-6 dish-box-wp lunch" data-cat="lunch" style="display: inline-block;">
                                    <div class="dish-box text-center">
                                        <div class="dist-img">
